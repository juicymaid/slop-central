<template>
    <div class="max-w-[1200px] mx-auto px-6 mb-12 transition-colors duration-200">
        <h1 class="text-4xl font-serif font-bold italic mb-4 mt-16 text-[#FAF8F5] drop-shadow-md">{{ model?.name??model?.hash }}</h1>
    ...
    <div class="text-center text-[#FAF8F5]/40 font-mono text-xs mt-8 mb-12 tracking-wide">
        ...
        <div class="text-[10px] mt-2 text-[#C9A84C]/60 tracking-widest uppercase">
            Showing {{ String(modelImages.length).padStart(4, '0') }} of {{ String(totalImages).padStart(4, '0') }} images
        </div>
    </div>
</template>
