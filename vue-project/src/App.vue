...
<template>
  ...
  <div class="min-h-screen transition-colors duration-300 bg-[#0D0D12]">
    ...
    <nav
      ...
      :style="{ marginLeft: webState.sidebarWidth > 0 ? (webState.sidebarWidth / 2) + 'px' : '0px', width: `calc(100% - ${webState.sidebarWidth}px - 2rem)`, maxWidth: '1200px' }">
      <div class="flex items-center justify-between w-full mx-auto">
        ...
        <RouterLink to="/" class="flex items-center group">
          ...
          <span class="ml-3 font-semibold font-sans text-lg tracking-tight text-[#FAF8F5]">Slop Central</span>
        </RouterLink>

        <!-- Search Bar -->
        <div class="flex-1 mx-6 max-w-2xl">
        ...
        <div class="flex items-center space-x-1 sm:space-x-2">
          ...
          <!-- New: Models link -->
          <RouterLink to="/models" class="hidden sm:block">
            <button
          ...
          <!-- New: Extras link -->
          <RouterLink to="/extras" class="hidden sm:block">
            <button
              class="magnetic-button px-4 py-2.5 rounded-full text-sm font-sans font-medium text-[#FAF8F5]/80 hover:text-[#FAF8F5] transition-colors"
              aria-label="Extras"
            >
    ...
    <!-- Main Content -->
    <div :class="['flex', hideNav ? '' : 'pt-20']">
      <main class="flex-grow px-6" :style="{ marginLeft: webState.sidebarWidth + 'px' }">
        <RouterView />
      </main>
    </div>
